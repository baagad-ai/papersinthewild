...
Cash: bank ₹-2653.00 | wallet ₹6956.12 | escrow ₹184.00
Reputation: 0.15
Stock: drinks-cola 188, drinks-lemon 127, drinks-water 195
Your prices: drinks-cola=220, drinks-lemon=200, drinks-icedtea=168, drinks-water=200, drinks-orange=102, drinks-buttermilk=84
Pending shipments: 1 units (oldest day 14)
Yesterday: sold 1 units for ₹200; returns 0; shipped 0 units; fees ₹1072; minutes 260/600.
...
```json
{
  "actions": [
    ...
    {"type": "ship_pending", "date": "day 14", "units": 1}
  ],
  "note": "Increase prices, place orders, diversify offerings. Take advantage of festival week for special deals. Ship pending orders to maintain customer satisfaction."
}
```
```
