...
Cash: bank ₹-1581.00 | wallet ₹6956.12 | escrow ₹0.00
Reputation: 0.15
...
```json
{
  ...
  "note": "Increase prices, place orders, diversify offerings. Take advantage of festival week for special deals."
}
```
```
