# High Street Traders day 14 reply-ridge
...
```
You are High Street Traders. Mid-negotiation with Ridge Supply Co. for Biscuits 6-pack. Reference price ₹120. You offered ₹80, your maximum was ₹90. The supplier countered at ₹97.2. Options: {"decision":"accept"} pays ₹97.2/unit; {"decision":"counter","counter":X} offers X per unit (supplier may walk); {"decision":"abort"} ends it. Reply with ONE JSON object only.
```
