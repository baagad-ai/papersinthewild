...
BORDER at (11,8): the outer wall has a hole; the world leaks into the void
...
- attempt 2: BORDER at (11,8): the outer wall has a hole; the world leaks into the void
...
PITCH: Relax and enjoy a warm drink at this charming cafe, complete with tables and a cozy nook at the counter.
```
```
