...
BOT at (10,8) [G]: the playtest bot wandered for 200 steps and never reached the goal (shortest path is 16)
...
PITCH: Enjoy a warm drink and pastry in this charming cafe, winding your way to a cozy corner nook.
```
