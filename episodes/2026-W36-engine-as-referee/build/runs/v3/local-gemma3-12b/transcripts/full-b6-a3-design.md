...
BORDER at (2,11): the outer wall has a hole; the world leaks into the void
Your trace cards so far:
- attempt 1: BORDER at (11,1): the outer wall has a hole; the world leaks into the void
- attempt 2: BORDER at (2,11): the outer wall has a hole; the world leaks into the void
...
PITCH: Navigate a charming, miniature hedge maze to reach the central fountain.
```
```
