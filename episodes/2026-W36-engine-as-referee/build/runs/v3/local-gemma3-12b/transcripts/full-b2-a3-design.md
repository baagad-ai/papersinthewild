...
PARSE [G]: expected exactly one G (goal), found 0
Your trace cards so far:
- attempt 1: SUPPORT at (3,1) [B2]: rests inside solid tiles; no floor touches it
- attempt 2: PARSE [G]: expected exactly one G (goal), found 0
