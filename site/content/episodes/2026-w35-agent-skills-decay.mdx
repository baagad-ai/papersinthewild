...
<TryIt
  label="Run the drawer yourself"
  prompt="cd papersinthewild/projects/ai-papers-explained/episodes/2026-W35-agent-skills-decay/build && MODELS=local:qwen3:8b node twins-lab.mjs"
/>
